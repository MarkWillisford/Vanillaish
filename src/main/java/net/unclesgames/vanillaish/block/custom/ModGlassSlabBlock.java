...
public class ModGlassSlabBlock extends GlassBlock implements Waterloggable {
  ...
  public ModGlassSlabBlock(Settings settings) {
    super(settings);
  }

  /**********************************************/
  /*  Override methods for slab functionality   */
  /**********************************************/
